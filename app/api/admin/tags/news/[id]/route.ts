...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to update news tag" }, { status: 500 });
  }
}

// DELETE: Delete a news tag
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to delete news tag" }, { status: 500 });
  }
}
